...
<script type="text/javascript">
	...
	{
		console.log( id);
		result = confirm("really wants to delete? ");
		if(result)
			window.location = "http://localhost:8080/deleteBooks/"+id;
	}
</script>
</head>
<body>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header" style="font-size: 30px;">
      <h1 class=" text-center" style="margin-left:470px;" >BookStack.com</h1>
    </div>
			...
			<tbody>
			   <%
                ...
                <tr>
						...
						<a href =# onclick="del(<%=id %>);return false;"
