...
public class HomeController {
	...
	public String loginHandler(@ModelAttribute User user,HttpSession session)
	{
		...
		session.setAttribute("message","Invalid User details!! try again!!");
		return "getlogin";
	}
	...
	public String RegHandler(@ModelAttribute User user,HttpSession session)
	{
		userrepo.save(user);
		session.setAttribute("msg"," You got Registered Successfully");
