...
public class HomeServices {
	...
	{
		Books[] books = this.restTemplate.getForObject("http://localhost:8080/books",Books[].class);
		return books;
	}
	...
	public Books addBook(Books newBook) throws URISyntaxException
	{
		...
		URI uri = new URI("http://localhost:8080/addBook");
...
//	public Books getBookbyId()
	...
	public Books getBookbyId(Integer id) {
		Books book = this.restTemplate.getForObject("http://localhost:8080/getbooks/"+ id , Books.class);
		return book;
	}
	...
	public void editBook(Books newBook) throws URISyntaxException {
		...
		URI uri = new URI("http://localhost:8080/updateById");
	...
	public void deleteById(Integer id) throws URISyntaxException {
		URI uri = new URI("http://localhost:8080/deleteBookbyId/"+id);
